...
eval("// extracted by mini-css-extract-plugin\n\n//# sourceURL=webpack:///./src/css/style.css?./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader!./node_modules/postcss-loader/src");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return controller; });\n/* harmony import */ var _services_localStorage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./services/localStorage */ \"./src/js/services/localStorage.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n // import { format } from \"path\";\n\nvar regExp = /^https?:\\/\\/(?:www\\.|(?!www))[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\\.[^\\s]{2,}|www\\.[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\\.[^\\s]{2,}|https?:\\/\\/(?:www\\.|(?!www))[a-zA-Z0-9]\\.[^\\s]{2,}|www\\.[a-zA-Z0-9]\\.[^\\s]{2,}/; //source from http://qaru.site/questions/642495/regular-expression-for-checking-website-url\n\nvar controller =\n/*#__PURE__*/\nfunction () {\n  function controller(Model, View) {\n    _classCallCheck(this, controller);\n\n    this._model = Model;\n    this._view = View;\n\n    this._view.refs.submitButton.addEventListener(\"click\", this.SubmitHandler.bind(this));\n\n    this._view.refs.cardsWrapper.addEventListener(\"click\", this.RemoveBookmarkHandler.bind(this));\n\n    this._view.refs.inputForm.addEventListener(\"submit\", function (e) {\n      e.preventDefault();\n    });\n\n    this._view.displayAll(this._model.items, this._view.refs.cardsWrapper, this._view.refs.template);\n  }\n\n  _createClass(controller, [{\n    key: \"SubmitHandler\",\n    value: function SubmitHandler(e) {\n      var _this = this;\n\n      e.preventDefault();\n\n      if (!this._view.refs.input.value.match(regExp)) {\n        alert('Введенный адрес не поддерживается.');\n        return;\n      }\n\n      ;\n\n      this._model.addBookmark(this._view.refs.input.value).then(function () {\n        _this._view.displayAll(_this._model.items, _this._view.refs.cardsWrapper, _this._view.refs.template);\n      }).catch(function (err) {\n        return console.log(\"Error while fetching, status err:\", err);\n      });\n    }\n  }, {\n    key: \"RemoveBookmarkHandler\",\n    value: function RemoveBookmarkHandler(e) {\n      e.preventDefault();\n      var target = e.target;\n      var nodeName = target.nodeName;\n      var elemClass = target.classList.contains(\"remove\");\n      if (nodeName !== \"BUTTON\" && !elemClass) return;\n      var url = target.parentNode.querySelector(\"span\").textContent.replace(\"URL: \", \"\");\n      console.log(url);\n\n      var index = this._model.items.findIndex(function (elem) {\n        if (url === elem.url) return true;\n      });\n\n      this._model.items.splice(index, 1);\n\n      _services_localStorage__WEBPACK_IMPORTED_MODULE_0__[\"LOCALSTORAGE\"].remove(url);\n\n      this._view.displayAll(this._model.items, this._view.refs.cardsWrapper, this._view.refs.template);\n    }\n  }]);\n\n  return controller;\n}();\n\n\n\n//# sourceURL=webpack:///./src/js/controller.js?");
